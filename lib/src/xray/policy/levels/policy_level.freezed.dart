...
/// @nodoc
mixin _$PolicyLevels4Ray {

 Map<String, PolicyLevelObject4Ray>? get levels;
/// Create a copy of PolicyLevels4Ray
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$PolicyLevels4RayCopyWith<PolicyLevels4Ray> get copyWith => _$PolicyLevels4RayCopyWithImpl<PolicyLevels4Ray>(this as PolicyLevels4Ray, _$identity);

  /// Serializes this PolicyLevels4Ray to a JSON map.
  Map<String, dynamic> toJson();


@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is PolicyLevels4Ray&&const DeepCollectionEquality().equals(other.levels, levels));
}
...
@override
String toString() {
  return 'PolicyLevels4Ray(levels: $levels)';
}
...
/// @nodoc
abstract mixin class $PolicyLevels4RayCopyWith<$Res>  {
  factory $PolicyLevels4RayCopyWith(PolicyLevels4Ray value, $Res Function(PolicyLevels4Ray) _then) = _$PolicyLevels4RayCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$PolicyLevels4RayCopyWithImpl<$Res>
    implements $PolicyLevels4RayCopyWith<$Res> {
  _$PolicyLevels4RayCopyWithImpl(this._self, this._then);

  final PolicyLevels4Ray _self;
  final $Res Function(PolicyLevels4Ray) _then;

/// Create a copy of PolicyLevels4Ray
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? levels = freezed,}) {
  return _then(_self.copyWith(
levels: freezed == levels ? _self.levels : levels // ignore: cast_nullable_to_non_nullable
as Map<String, PolicyLevelObject4Ray>?,
  ));
}
...
/// Adds pattern-matching-related methods to [PolicyLevels4Ray].
extension PolicyLevels4RayPatterns on PolicyLevels4Ray {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _PolicyLevels4Ray value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _PolicyLevels4Ray() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _PolicyLevels4Ray value)  $default,){
final _that = this;
switch (_that) {
case _PolicyLevels4Ray():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _PolicyLevels4Ray value)?  $default,){
final _that = this;
switch (_that) {
case _PolicyLevels4Ray() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( Map<String, PolicyLevelObject4Ray>? levels)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _PolicyLevels4Ray() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( Map<String, PolicyLevelObject4Ray>? levels)  $default,) {final _that = this;
switch (_that) {
case _PolicyLevels4Ray():
return $default(_that.levels);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( Map<String, PolicyLevelObject4Ray>? levels)?  $default,) {final _that = this;
switch (_that) {
case _PolicyLevels4Ray() when $default != null:
return $default(_that.levels);case _:
  return null;
...
class _PolicyLevels4Ray implements PolicyLevels4Ray {
  const _PolicyLevels4Ray({final  Map<String, PolicyLevelObject4Ray>? levels}): _levels = levels;
  factory _PolicyLevels4Ray.fromJson(Map<String, dynamic> json) => _$PolicyLevels4RayFromJson(json);
...
@pragma('vm:prefer-inline')
_$PolicyLevels4RayCopyWith<_PolicyLevels4Ray> get copyWith => __$PolicyLevels4RayCopyWithImpl<_PolicyLevels4Ray>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$PolicyLevels4RayToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _PolicyLevels4Ray&&const DeepCollectionEquality().equals(other._levels, _levels));
}
...
/// @nodoc
abstract mixin class _$PolicyLevels4RayCopyWith<$Res> implements $PolicyLevels4RayCopyWith<$Res> {
  factory _$PolicyLevels4RayCopyWith(_PolicyLevels4Ray value, $Res Function(_PolicyLevels4Ray) _then) = __$PolicyLevels4RayCopyWithImpl;
@override @useResult
$Res call({
 Map<String, PolicyLevelObject4Ray>? levels
});
...
/// @nodoc
class __$PolicyLevels4RayCopyWithImpl<$Res>
    implements _$PolicyLevels4RayCopyWith<$Res> {
  __$PolicyLevels4RayCopyWithImpl(this._self, this._then);

  final _PolicyLevels4Ray _self;
  final $Res Function(_PolicyLevels4Ray) _then;

/// Create a copy of PolicyLevels4Ray
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? levels = freezed,}) {
  return _then(_PolicyLevels4Ray(
