...
@useResult
$Res call({
 String? network, String? security, Tls4Ray? tlsSettings, Reality4Ray? realitySettings, RawTransport4Ray? rawSettings, XHttpTransport4Ray? xhttpSettings, KcpTransport4Ray? kcpSettings, GrpcTransport4Ray? grpcSettings, WebSocketTransport4Ray? wsSettings, HttpUpgradeTransport4Ray? httpupgradeSettings, HysteriaTransport4Ray? hysteriaSettings, FinalMask4Ray? finalmask, Sockopt4Ray? sockopt
});


$Tls4RayCopyWith<$Res>? get tlsSettings;$Reality4RayCopyWith<$Res>? get realitySettings;$RawTransport4RayCopyWith<$Res>? get rawSettings;$XHttpTransport4RayCopyWith<$Res>? get xhttpSettings;$KcpTransport4RayCopyWith<$Res>? get kcpSettings;$GrpcTransport4RayCopyWith<$Res>? get grpcSettings;$WebSocketTransport4RayCopyWith<$Res>? get wsSettings;$HttpUpgradeTransport4RayCopyWith<$Res>? get httpupgradeSettings;$HysteriaTransport4RayCopyWith<$Res>? get hysteriaSettings;$FinalMask4RayCopyWith<$Res>? get finalmask;$Sockopt4RayCopyWith<$Res>? get sockopt;
...
as HysteriaTransport4Ray?,finalmask: freezed == finalmask ? _self.finalmask : finalmask // ignore: cast_nullable_to_non_nullable
as FinalMask4Ray?,sockopt: freezed == sockopt ? _self.sockopt : sockopt // ignore: cast_nullable_to_non_nullable
as Sockopt4Ray?,
  ));
}
/// Create a copy of StreamSettings4Ray
...
@override
@pragma('vm:prefer-inline')
$FinalMask4RayCopyWith<$Res>? get finalmask {
    if (_self.finalmask == null) {
    return null;
  }

  return $FinalMask4RayCopyWith<$Res>(_self.finalmask!, (value) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String? network,  String? security,  Tls4Ray? tlsSettings,  Reality4Ray? realitySettings,  RawTransport4Ray? rawSettings,  XHttpTransport4Ray? xhttpSettings,  KcpTransport4Ray? kcpSettings,  GrpcTransport4Ray? grpcSettings,  WebSocketTransport4Ray? wsSettings,  HttpUpgradeTransport4Ray? httpupgradeSettings,  HysteriaTransport4Ray? hysteriaSettings,  FinalMask4Ray? finalmask,  Sockopt4Ray? sockopt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _StreamSettings4Ray() when $default != null:
return $default(_that.network,_that.security,_that.tlsSettings,_that.realitySettings,_that.rawSettings,_that.xhttpSettings,_that.kcpSettings,_that.grpcSettings,_that.wsSettings,_that.httpupgradeSettings,_that.hysteriaSettings,_that.finalmask,_that.sockopt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String? network,  String? security,  Tls4Ray? tlsSettings,  Reality4Ray? realitySettings,  RawTransport4Ray? rawSettings,  XHttpTransport4Ray? xhttpSettings,  KcpTransport4Ray? kcpSettings,  GrpcTransport4Ray? grpcSettings,  WebSocketTransport4Ray? wsSettings,  HttpUpgradeTransport4Ray? httpupgradeSettings,  HysteriaTransport4Ray? hysteriaSettings,  FinalMask4Ray? finalmask,  Sockopt4Ray? sockopt)  $default,) {final _that = this;
switch (_that) {
case _StreamSettings4Ray():
return $default(_that.network,_that.security,_that.tlsSettings,_that.realitySettings,_that.rawSettings,_that.xhttpSettings,_that.kcpSettings,_that.grpcSettings,_that.wsSettings,_that.httpupgradeSettings,_that.hysteriaSettings,_that.finalmask,_that.sockopt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String? network,  String? security,  Tls4Ray? tlsSettings,  Reality4Ray? realitySettings,  RawTransport4Ray? rawSettings,  XHttpTransport4Ray? xhttpSettings,  KcpTransport4Ray? kcpSettings,  GrpcTransport4Ray? grpcSettings,  WebSocketTransport4Ray? wsSettings,  HttpUpgradeTransport4Ray? httpupgradeSettings,  HysteriaTransport4Ray? hysteriaSettings,  FinalMask4Ray? finalmask,  Sockopt4Ray? sockopt)?  $default,) {final _that = this;
switch (_that) {
case _StreamSettings4Ray() when $default != null:
return $default(_that.network,_that.security,_that.tlsSettings,_that.realitySettings,_that.rawSettings,_that.xhttpSettings,_that.kcpSettings,_that.grpcSettings,_that.wsSettings,_that.httpupgradeSettings,_that.hysteriaSettings,_that.finalmask,_that.sockopt);case _:
  return null;
...
class _StreamSettings4Ray implements StreamSettings4Ray {
  const _StreamSettings4Ray({this.network, this.security, this.tlsSettings, this.realitySettings, this.rawSettings, this.xhttpSettings, this.kcpSettings, this.grpcSettings, this.wsSettings, this.httpupgradeSettings, this.hysteriaSettings, this.finalmask, this.sockopt});
...
@override final  FinalMask4Ray? finalmask;
